 ...
 * <p>please extends this class when you want to add an event(operation). please return a {@link com.github.smoketest.util.testNG.log.EventLog} in very function</p>
 * @author uniqueT
 *
 */
public abstract class BaseEvent {
	 ...
	 * @return element
	 */
	protected static WebElement getVisiableElement(By by) {
